...
Exception pour les classe Facade PigeonsLibrairy.Facade


## Inheritance Hierarchy
<a href="http://msdn2.microsoft.com/en-us/library/e5kfa45b" target="_blank">System.Object</a><br />&nbsp;&nbsp;<a href="http://msdn2.microsoft.com/en-us/library/c18k6c59" target="_blank">System.Exception</a><br />&nbsp;&nbsp;&nbsp;&nbsp;PigeonsLibrairy.Exceptions.FacadeException<br />
...
**C++**<br />
``` C++
public ref class FacadeException : public Exception
```

**F#**<br />
``` F#
type FacadeException =  
    class
        inherit Exception
    end
```

The FacadeException type exposes the following members.
...
<a href="#facadeexception-class">Back to Top</a>
