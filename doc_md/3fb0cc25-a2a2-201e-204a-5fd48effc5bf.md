...
Exception pour les classe Service PigeonsLibrairy.Service


## Inheritance Hierarchy
<a href="http://msdn2.microsoft.com/en-us/library/e5kfa45b" target="_blank">System.Object</a><br />&nbsp;&nbsp;<a href="http://msdn2.microsoft.com/en-us/library/c18k6c59" target="_blank">System.Exception</a><br />&nbsp;&nbsp;&nbsp;&nbsp;PigeonsLibrairy.Exceptions.ServiceException<br />
...
**C++**<br />
``` C++
public ref class ServiceException : public Exception
```
...
<a href="#serviceexception-class">Back to Top</a>
