# task.COLUMN_TASK_ISIMPORTANT Field
...
**VB**<br />
``` VB
Public Const COLUMN_TASK_ISIMPORTANT As String = "task_isimportant"
```

**C++**<br />
``` C++
public:
literal String^ COLUMN_TASK_ISIMPORTANT = "task_isimportant"
```

**F#**<br />
``` F#
static val mutable COLUMN_TASK_ISIMPORTANT: string
```
