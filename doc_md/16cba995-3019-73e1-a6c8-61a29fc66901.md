...
Service pour la table <a href="f6e3b8f2-5289-041c-bfed-7d1e9141308b">chathistory</a>


## Inheritance Hierarchy
<a href="http://msdn2.microsoft.com/en-us/library/e5kfa45b" target="_blank">System.Object</a><br />&nbsp;&nbsp;<a href="75ba97f1-dce7-6ccb-b914-5f3ebe35b9df">PigeonsLibrairy.Service.Implementation.Service</a>(<a href="f6e3b8f2-5289-041c-bfed-7d1e9141308b">chathistory</a>)<br />&nbsp;&nbsp;&nbsp;&nbsp;PigeonsLibrairy.Service.Implementation.ChatHistoryService<br />
...
**C#**<br />
``` C#
public class ChatHistoryService : Service<chathistory>, 
	IChatHistoryService, IService<chathistory>
```

**VB**<br />
``` VB
Public Class ChatHistoryService
	Inherits Service(Of chathistory)
	Implements IChatHistoryService, IService(Of chathistory)
```

**C++**<br />
``` C++
public ref class ChatHistoryService : public Service<chathistory^>, 
	IChatHistoryService, IService<chathistory^>
```
...
type ChatHistoryService =  
    class
        inherit Service<chathistory>
        interface IChatHistoryService
        interface IService<chathistory>
    end
```

The ChatHistoryService type exposes the following members.


## Constructors
&nbsp;<table><tr><th></th><th>Name</th><th>Description</th></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="1e7ba3f6-380a-53d1-82ac-a281ed6e87a5">ChatHistoryService</a></td><td>
Constructeur</td></tr></table>&nbsp;
<a href="#chathistoryservice-class">Back to Top</a>
