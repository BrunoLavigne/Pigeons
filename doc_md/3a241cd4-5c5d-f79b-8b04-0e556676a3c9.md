...
Service pour la table Task (<a href="ed7fd571-3ebd-bb10-4923-b1c31d5523f3">task</a>)


## Inheritance Hierarchy
<a href="http://msdn2.microsoft.com/en-us/library/e5kfa45b" target="_blank">System.Object</a><br />&nbsp;&nbsp;<a href="75ba97f1-dce7-6ccb-b914-5f3ebe35b9df">PigeonsLibrairy.Service.Implementation.Service</a>(<a href="ed7fd571-3ebd-bb10-4923-b1c31d5523f3">task</a>)<br />&nbsp;&nbsp;&nbsp;&nbsp;PigeonsLibrairy.Service.Implementation.TaskService<br />
...
public class TaskService : Service<task>, 
	ITaskService, IService<task>
```

**VB**<br />
``` VB
Public Class TaskService
	Inherits Service(Of task)
	Implements ITaskService, IService(Of task)
```

**C++**<br />
``` C++
public ref class TaskService : public Service<task^>, 
	ITaskService, IService<task^>
```
...
## Constructors
&nbsp;<table><tr><th></th><th>Name</th><th>Description</th></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="2c54a2c0-1c9f-048a-dda2-6bb4e0a847d7">TaskService</a></td><td>
Constructeur</td></tr></table>&nbsp;
<a href="#taskservice-class">Back to Top</a>
