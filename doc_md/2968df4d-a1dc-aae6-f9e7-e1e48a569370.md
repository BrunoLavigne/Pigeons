# IService(*TEntity*) Interface
 

Interface pour la classe <a href="75ba97f1-dce7-6ccb-b914-5f3ebe35b9df">Service(TEntity)</a>
...
**VB**<br />
``` VB
Public Interface IService(Of TEntity As Class)
```
...
**F#**<br />
``` F#
type IService<'TEntity when 'TEntity : not struct> =  interface end
```


#### Type Parameters
&nbsp;<dl><dt>TEntity</dt><dd>Le type de l'Entity</dd></dl>&nbsp;
The IService(TEntity) type exposes the following members.
...
<a href="#iservice(*tentity*)-interface">Back to Top</a>
