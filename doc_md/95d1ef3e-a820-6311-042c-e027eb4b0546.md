...
Exception pour les classe DAO PigeonsLibrairy.DAO


## Inheritance Hierarchy
<a href="http://msdn2.microsoft.com/en-us/library/e5kfa45b" target="_blank">System.Object</a><br />&nbsp;&nbsp;<a href="http://msdn2.microsoft.com/en-us/library/c18k6c59" target="_blank">System.Exception</a><br />&nbsp;&nbsp;&nbsp;&nbsp;PigeonsLibrairy.Exceptions.DAOException<br />
...
**C++**<br />
``` C++
public ref class DAOException : public Exception
```
...
The DAOException type exposes the following members.
...
<a href="#daoexception-class">Back to Top</a>
