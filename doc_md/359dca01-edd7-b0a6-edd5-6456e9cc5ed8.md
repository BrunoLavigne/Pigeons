...
**VB**<br />
``` VB
Public Const COLUMN_POSITION As String = "position"
```

**C++**<br />
``` C++
public:
literal String^ COLUMN_POSITION = "position"
```

**F#**<br />
``` F#
static val mutable COLUMN_POSITION: string
```
