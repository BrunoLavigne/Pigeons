# IChatHistoryService Interface
 

Interface pour les service pour la table <a href="f6e3b8f2-5289-041c-bfed-7d1e9141308b">chathistory</a>
...
Public Interface IChatHistoryService
	Inherits IService(Of chathistory)
```

**C++**<br />
``` C++
public interface class IChatHistoryService : IService<chathistory^>
```

**F#**<br />
``` F#
type IChatHistoryService =  
    interface
        interface IService<chathistory>
    end
```

The IChatHistoryService type exposes the following members.
...
<a href="#ichathistoryservice-interface">Back to Top</a>
