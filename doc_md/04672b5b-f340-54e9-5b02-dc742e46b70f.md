# person.COLUMN_ORGANIZATION Field
...
**VB**<br />
``` VB
Public Const COLUMN_ORGANIZATION As String = "organization"
```

**C++**<br />
``` C++
public:
literal String^ COLUMN_ORGANIZATION = "organization"
```

**F#**<br />
``` F#
static val mutable COLUMN_ORGANIZATION: string
```
