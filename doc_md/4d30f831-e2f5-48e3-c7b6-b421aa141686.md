# AssignationDAO Class
 

DAO de la table <a href="912fb7ce-cbcd-e571-4846-3144af127f9c">assignation</a>


## Inheritance Hierarchy
<a href="http://msdn2.microsoft.com/en-us/library/e5kfa45b" target="_blank">System.Object</a><br />&nbsp;&nbsp;<a href="936963c1-f9f9-454a-06ea-6c5e62510e66">PigeonsLibrairy.DAO.Implementation.DAO</a>(<a href="912fb7ce-cbcd-e571-4846-3144af127f9c">assignation</a>)<br />&nbsp;&nbsp;&nbsp;&nbsp;PigeonsLibrairy.DAO.Implementation.AssignationDAO<br />
...
**C#**<br />
``` C#
public class AssignationDAO : DAO<assignation>
```

**VB**<br />
``` VB
Public Class AssignationDAO
	Inherits DAO(Of assignation)
```

**C++**<br />
``` C++
public ref class AssignationDAO : public DAO<assignation^>
```
...
type AssignationDAO =  
    class
        inherit DAO<assignation>
    end
```

The AssignationDAO type exposes the following members.


## Constructors
&nbsp;<table><tr><th></th><th>Name</th><th>Description</th></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="8017bc08-343a-b34c-182b-effe6c045a8e">AssignationDAO</a></td><td>
Constructeur</td></tr></table>&nbsp;
<a href="#assignationdao-class">Back to Top</a>
